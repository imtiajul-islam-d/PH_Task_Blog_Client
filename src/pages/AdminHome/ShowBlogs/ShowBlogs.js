        ...
        >
          ...
          <td className="p-3 text-right">
            <button
              ...
              className="bg-red-500 px-2 py-2 text-white hover:text-red-500 hover:bg-white border border-red-500 "
            >
              Delete
            </button>
          </td>
  ...
  return (
    <div className="container p-2 mx-auto sm:p-4 dark:text-gray-100">
      <div className="flex justify-end items-center">
        <Link
          to="/admin/add"
          className="bg-yellow-500 border border-yellow-500 text-white hover:bg-white hover:text-yellow-500 px-3 py-2 hover:border hover:border-yellow-500"
        >
          Add a blog
        </Link>
      </div>
